                ...
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.get(url)
                            ...
                            results.forEach(function (element) {
                                var name = element.name, place_id = element.place_id, rating = element.rating, user_ratings_total = element.user_ratings_total, reference = element.reference, vicinity = element.vicinity, opening_hours = element.opening_hours;
                                elements.push({
                                    name: name,
                                    place_id: place_id,
                                    rating: rating,
